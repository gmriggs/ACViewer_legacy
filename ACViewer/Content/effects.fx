...
Texture xTexture;
sampler TextureSampler = sampler_state { texture = <xTexture>; magfilter = LINEAR; minfilter = ANISOTROPIC; mipfilter=LINEAR; AddressU = Wrap; AddressV = Wrap; MaxAnisotropy = 8; };
