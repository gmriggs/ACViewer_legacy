...
namespace ACViewer.Primitives
{
    ...
    public class SpherePrimitive : GeometricPrimitive
    {
        ...
        /// </summary>
        public SpherePrimitive(GraphicsDevice graphicsDevice, float diameter, int tessellation, Vector3 position)
        {
            if (tessellation < 3)
            ...
            AddVertex(Vector3.Down * radius + position, Vector3.Down);
            ...
            for (int i = 0; i < verticalSegments - 1; i++)
            {
                ...
                for (int j = 0; j < horizontalSegments; j++)
                {
                    ...
                    AddVertex(normal * radius + position, normal);
                }
            }

            // Finish with a single vertex at the top of the sphere.
            AddVertex(Vector3.Up * radius + position, Vector3.Up);
